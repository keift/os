...
var TemplatesScriptsManager = class extends SignalManager.SignalManager {
  ...
  _readDirectory(directory) {
    return new Promise((resolve, reject) => {
      ...
      directory.enumerate_children_async(Enums.DEFAULT_ATTRIBUTES, Gio.FileQueryInfoFlags.NONE, GLib.PRIORITY_DEFAULT, this._entriesEnumerateCancellable, (source, result) => {
        this._entriesEnumerateCancellable = null;
        let fileList = [];
        try {
          ...
          while ((info = fileEnum.next_file(null))) {
            ...
            if (this._flags & TemplatesScriptsManagerFlags.ONLY_EXECUTABLE && !isDir && !info.get_attribute_boolean('access::can-execute')) {
              continue;
            }
          ...
          if (e.matches(Gio.IOErrorEnum, Gio.IOErrorEnum.CANCELLED)) {
            ...
            reject(new GLib.Error(Gio.IOErrorEnum, Gio.IOErrorEnum.FAILED, 'file-read-error'));
          }
          return;
        }
        fileList.sort((a, b) => {

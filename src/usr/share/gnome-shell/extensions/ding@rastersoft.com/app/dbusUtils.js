...
class ProxyManager {
  ...
  constructor(dbusManager, serviceName, objectName, interfaceName, inSystemBus, programNeeded) {
    ...
    if (typeof programNeeded == 'string') {
      ...
      this._programNeeded = [_('"${programName}" is needed for Desktop Icons').replace('${programName}', programNeeded), _('For this functionality to work in Desktop Icons, you must install "${programName}" in your system.').replace('${programName}', programNeeded), programNeeded];
    } else {
  ...
  async makeNewProxy(delay = 0) {
    ...
    if (this._interfaceXML) {
      ...
      try {
        new Gio.DBusProxy.makeProxyWrapper(this._interfaceXML)(this._inSystemBus ? Gio.DBus.system : Gio.DBus.session, this._serviceName, this._objectName, (proxy, error) => {
          this._beingLaunched = false;
          if (error === null) {
...
class DBusManager {
  ...
  constructor() {
    ...
    this._dbusSystemProxy = new Gio.DBusProxy.makeProxyWrapper(interfaceXML)(Gio.DBus.system, 'org.freedesktop.DBus', '/org/freedesktop/DBus', null);
    ...
    interfaceXML = this.getInterface('org.freedesktop.DBus', '/org/freedesktop/DBus', 'org.freedesktop.DBus', Enums.DBusBus.SESSION, true); // use DBus Introspection
    this._dbusLocalProxy = new Gio.DBusProxy.makeProxyWrapper(interfaceXML)(Gio.DBus.session, 'org.freedesktop.DBus', '/org/freedesktop/DBus', null);
    ...
    interfaceXML = this.getInterface('org.freedesktop.Notifications', '/org/freedesktop/Notifications', 'org.freedesktop.Notifications', Enums.DBusBus.SESSION, false); // get interface from local code
    this._notifyProxy = new Gio.DBusProxy.makeProxyWrapper(interfaceXML)(Gio.DBus.session, 'org.freedesktop.Notifications', '/org/freedesktop/Notifications', null);
  }
  ...
  getIntrospectionData(serviceName, objectName, inSystemBus) {
    let data = null;
    try {
      let wraper = new Gio.DBusProxy.makeProxyWrapper(DBusInterfaces.DBusInterfaces['org.freedesktop.DBus.Introspectable'])(inSystemBus ? Gio.DBus.system : Gio.DBus.session, serviceName, objectName, null);
...
class DbusOperationsManager {
  ...
  ShowItemPropertiesRemote(selection, timestamp, callback) {
    ...
    this.freeDesktopFileManager.proxy.ShowItemPropertiesRemote(selection, this._getStartupId(selection, timestamp), (result, error) => {
      if (callback) {
  ...
  ShowItemsRemote(showInFilesList, timestamp, callback) {
    ...
    this.freeDesktopFileManager.proxy.ShowItemsRemote(showInFilesList, this._getStartupId(showInFilesList, timestamp), (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  ShowFileRemote(uri, integer, boolean, callback) {
    ...
    this.gnomeNautilusPreviewManager.proxy.ShowFileRemote(uri, integer, boolean, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  ExtractRemote(extractFileItem, folder, boolean, callback) {
    ...
    this.gnomeArchiveManager.proxy.ExtractRemote(extractFileItem, folder, true, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  CompressRemote(compressFileItems, folder, boolean, callback) {
    ...
    this.gnomeArchiveManager.proxy.CompressRemote(compressFileItems, folder, boolean, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  _getStartupId(fileUris, timestamp) {
    ...
    return context.get_startup_notify_id(
      this._fileManager,
...
class RemoteFileOperationsManager extends DbusOperationsManager {
  ...
  MoveURIsRemote(fileList, uri, callback) {
    ...
    this.fileOperationsManager.proxy.MoveURIsRemote(fileList, uri, this.platformData(), (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  CopyURIsRemote(fileList, uri, callback) {
    ...
    this.fileOperationsManager.proxy.CopyURIsRemote(fileList, uri, this.platformData(), (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  async RenameURIRemote(fileList, uri, callback) {
    ...
    this.fileOperationsManager.proxy.RenameURIRemote(fileList, uri, platformData, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  TrashURIsRemote(fileList, callback) {
    ...
    this.fileOperationsManager.proxy.TrashURIsRemote(fileList, this.platformData(), (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  DeleteURIsRemote(fileList, callback) {
    ...
    this.fileOperationsManager.proxy.DeleteURIsRemote(fileList, this.platformData(), (source, error) => {
      if (callback) {
  ...
  EmptyTrashRemote(askConfirmation, callback) {
    ...
    this.fileOperationsManager.proxy.EmptyTrashRemote(askConfirmation, this.platformData(), (source, error) => {
      if (callback) {
        callback(source, error);
      }
      if (error) {
  ...
  UndoRemote(callback) {
    ...
    this.fileOperationsManager.proxy.UndoRemote(this.platformData(), (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  RedoRemote(callback) {
    ...
    this.fileOperationsManager.proxy.RedoRemote(this.platformData(), (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
...
class LegacyRemoteFileOperationsManager extends DbusOperationsManager {
  ...
  MoveURIsRemote(fileList, uri, callback) {
    ...
    this.fileOperationsManager.proxy.MoveURIsRemote(fileList, uri, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  CopyURIsRemote(fileList, uri, callback) {
    ...
    this.fileOperationsManager.proxy.CopyURIsRemote(fileList, uri, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  RenameURIRemote(fileList, uri, callback) {
    ...
    this.fileOperationsManager.proxy.RenameFileRemote(fileList, uri, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  TrashURIsRemote(fileList, callback) {
    ...
    this.fileOperationsManager.proxy.TrashFilesRemote(fileList, (result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  DeleteURIsRemote(fileList, callback) {
    ...
    this.fileOperationsManager.proxy.TrashFilesRemote(fileList, (source, error) => {
  ...
  EmptyTrashRemote(callback) {
    ...
    this.fileOperationsManager.proxy.EmptyTrashRemote((source, error) => {
      if (callback) {
        callback(source, error);
      }
      if (error) {
  ...
  UndoRemote(callback) {
    ...
    this.fileOperationsManager.proxy.UndoRemote((result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
  ...
  RedoRemote(callback) {
    ...
    this.fileOperationsManager.proxy.RedoRemote((result, error) => {
      if (callback) {
        callback(result, error);
      }
      if (error) {
...
function init(mainApp) {
  ...
  let data = dbusManagerObject.getIntrospectionData('org.gnome.Nautilus', '/org/gnome/Nautilus/FileOperations2', Enums.DBusBus.SESSION);

  if (data) {
    // NautilusFileOperations2
    NautilusFileOperations2 = new ProxyManager(dbusManagerObject, 'org.gnome.Nautilus', '/org/gnome/Nautilus/FileOperations2', 'org.gnome.Nautilus.FileOperations2', Enums.DBusBus.SESSION, 'Nautilus');
  } else {
    ...
    NautilusFileOperations2 = new ProxyManager(dbusManagerObject, 'org.gnome.Nautilus', '/org/gnome/Nautilus', 'org.gnome.Nautilus.FileOperations', Enums.DBusBus.SESSION, 'Nautilus');
  }

  FreeDesktopFileManager = new ProxyManager(dbusManagerObject, 'org.freedesktop.FileManager1', '/org/freedesktop/FileManager1', 'org.freedesktop.FileManager1', Enums.DBusBus.SESSION, 'Nautilus');

  GnomeNautilusPreview = new ProxyManager(dbusManagerObject, 'org.gnome.NautilusPreviewer', '/org/gnome/NautilusPreviewer', 'org.gnome.NautilusPreviewer', Enums.DBusBus.SESSION, 'Nautilus-Sushi');

  GnomeArchiveManager = new ProxyManager(dbusManagerObject, 'org.gnome.ArchiveManager1', '/org/gnome/ArchiveManager1', 'org.gnome.ArchiveManager1', Enums.DBusBus.SESSION, 'File-roller');

  GtkVfsMetadata = new ProxyManager(dbusManagerObject, 'org.gtk.vfs.Metadata', '/org/gtk/vfs/metadata', 'org.gtk.vfs.Metadata', Enums.DBusBus.SESSION, 'Gvfs daemon');

  SwitcherooControl = new ProxyManager(dbusManagerObject, 'net.hadess.SwitcherooControl', '/net/hadess/SwitcherooControl', 'net.hadess.SwitcherooControl', Enums.DBusBus.SYSTEM, 'Switcheroo control');
  ...
  extensionControl = Gio.DBusActionGroup.get(Gio.DBus.session, 'com.rastersoft.dingextension', '/com/rastersoft/dingextension/control');

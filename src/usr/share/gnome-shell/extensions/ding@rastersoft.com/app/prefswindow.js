...
function preferencesFrame(_Gtk, desktopSettings, nautilusSettings, gtkSettings) {
  ...
  frame.add(
    buildSelector(desktopSettings, 'start-corner', _('New icons alignment'), {
  ...
  try {
    nautilusBox.add(
      buildSelector(nautilusSettings, 'executable-text-activation', _('Action to do when launching a program from the desktop'), {
  ...
  nautilusBox.add(
    buildSelector(nautilusSettings, 'show-image-thumbnails', _('Show image thumbnails'), {
      never: _('Never'),

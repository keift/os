...
cp ./assets/logo-black.png ./src/usr/share/icons/hicolor/scalable/apps/fedora-logo-icon.png
...
cp ./assets/logo-white-small.png ./src/usr/share/anaconda/pixmaps/anaconda_header.png
cp ./assets/logo-white-small.png ./src/usr/share/anaconda/pixmaps/sidebar-logo.png
